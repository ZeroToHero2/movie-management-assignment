...
export default {
  ...
  DATABASE: {
    ...
    MAX_QUERY_EXECUTION_TIME: process.env.DATABASE_MAX_QUERY_EXECUTION_TIME || 10000,
    POOL_SIZE: process.env.DATABASE_POOL_SIZE || 50,
    MAX: process.env.DATABASE_MAX || 10,
    MIN: process.env.DATABASE_MIN || 1,
    IDLE_TIMEOUT_MILLIS: process.env.DATABASE_IDLE_TIMEOUT_MILLIS || 1000,
  },
  RABBITMQ: {
